...
namespace MTRandom
{
	...
	public class MTRandom
	{
		...
		/// Initializes a new instance of the <see cref="MTRandom"/> class.
		/// </summary>
		/// <param DisplayName="seed">Seed (integer).</param>
		...
		/// Initializes a new instance of the <see cref="MTRandom"/> class.
		/// </summary>
		/// <param DisplayName="phrase">Phrase (seed string).</param>
		...
		/// than or equal to one.
		/// </returns>
		/// <param DisplayName="temperature">Temperature.</param>
		...
		/// <param DisplayName="order">Order.</param>
		...
		#region RANGE
		/// <summary>
		/// Returns the next pseudo-random number integer between <paramref DisplayName="min"/> [inclusive] and <paramref DisplayName="max"/> [inclusive].
		/// </summary>
		/// <param DisplayName="min">Minimum.</param>
		/// <param DisplayName="max">Maximum.</param>
		public int Range(int min, int max)
		{
			return _rand.Next(min,max+1);
		}
		/// <summary>
		/// Returns the next pseudo-random number integer between <paramref DisplayName="min"/> [inclusive] and <paramref DisplayName="max"/> [depend on <paramref DisplayName="includeMax"/>].
		/// </summary>
		/// <param DisplayName="min">Minimum.</param>
		/// <param DisplayName="max">Max.</param>
		/// <param DisplayName="includeMax">If set to <c>true</c> include <paramref DisplayName="Max"/>.</param>
		...
		/// Use a range between <paramref DisplayName="min"/> [inclusive] and <paramref DisplayName="max"/> [inclusive] to reduce the color range.
		/// </summary>
		/// <param DisplayName="min">Minimum.</param>
		/// <param DisplayName="max">Max.</param>
		...
		/// </summary>
		/// <returns>The in point as Vector2.</returns>
		/// <param DisplayName="n">Normalization type (STDNORMAL or POWERLAW).</param>
		/// <param DisplayName="t">Temperature.</param>
		...
		/// <param DisplayName="x">The x coordinate.</param>
		/// <param DisplayName="newMin">New minimum.</param>
		/// <param DisplayName="newMax">New max.</param>
		/// <param DisplayName="oldMin">Old minimum.</param>
		/// <param DisplayName="oldMax">Old max.</param>
