...
namespace MTRandom
{
	...
	public static class RandomSphere
	{
		...
		/// Surface.
		/// </summary>
		/// <param DisplayName="_rand">random generator.</param>
	    ...
	    /// </summary>
	    /// <param DisplayName="spotAngle">[0..180] specifies the angle of the cone. </param>
		/// <remarks>
		...
		/// <param DisplayName="spotAngle">Spot angle.</param>
		/// <param DisplayName="_rand">_rand.</param>
		/// <param DisplayName="orientation">Orientation.</param>
		...
		/// <param DisplayName="spotAngle">Spot angle.</param>
		/// <param DisplayName="_rand">_rand.</param>
		/// <param DisplayName="relativeTo">Relative to.</param>
		/// <param DisplayName="radius">Radius.</param>
	    ...
	    /// </summary>
	    /// <param DisplayName="innerSpotAngle">[0..180] specifies the inner cone that should be excluded.</param>
	    /// <param DisplayName="outerSpotAngle">[0..180] specifies the outer cone that should be included.</param>
		...
		/// <param DisplayName="innerSpotAngle">Inner spot angle.</param>
		/// <param DisplayName="outerSpotAngle">Outer spot angle.</param>
		/// <param DisplayName="_rand">_rand.</param>
		/// <param DisplayName="orientation">Orientation.</param>
